/**
 * @claude-code-remote/protocol, the PORTABLE wire contract shared by the daemon and every client.
 *
 ...
 * `@claude-code-remote/protocol/node` (node:crypto, used by the daemon and CLI). The RN app supplies its own
